...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
const String SERIAL_NUMBER = "000821a20305";          // Serial number of the product
const String AP_LOGIN = "FidoElectronics22";       // Access Point (AP) mode default login
const String AP_PASS = "55506efb";          // AP mode default password
const String STS_LOGIN = "99629749";                 // Login to access settings in AP mode 
const String STS_PASS = "172c889f";                    // Password to access settings in AP mode

...
const String END_POINT = "/wifi_lock/from_device";
const String SETTINGS_END_POINT = "/wifi_lock/device_settings";
////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////// PIN VALUES //////////////////////////////////////////////////////
// servo ESP connection pin
const int IN_PIN = 3;           // D1 // GPIO3  // RX
const int OUT_PIN = 2;
...
void setup() {
  ...
  httpRespSettings = sendRequest(HIDDEN_SERVER + SETTINGS_END_POINT, "{\"serial_num\":\"" + SERIAL_NUMBER + "\"}");
  deviceSettings(httpRespSettings);
...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
        httpResp = sendRequest(HIDDEN_SERVER + END_POINT, "{\"serial_num\":\"" + SERIAL_NUMBER + "\", \"state\":\"" + lockState + "\"}");
        ...
        else if (actionRequested == "OFF" && actionTaken == "NO") {
