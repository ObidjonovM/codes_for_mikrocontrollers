...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
const String DEVICE_NAME = "gerkon_5x";               // Device name of the product
const String SERIAL_NUMBER = "000421c0f15f";          // Serial number of the product
const bool ACTIONS = false;                           // Actions of the product
const String AP_LOGIN = "FidoElectronics17";          // Access Point (AP) mode default login

...
//////////////////////////////////// PIN VALUES //////////////////////////////////////////////////////
const int DAT_PIN0 = 4;          // D2
const int DAT_PIN1 = 5;          // D1
const int DAT_PIN2 = 13;         // D7
const int DAT_PIN3 = 12;         // D6
const int DAT_PIN4 = 14;         // D5
const int SAPS_BTN_PIN = 3;      // RX
...
void setup() {
  ...
  pinMode(DAT_PIN0, INPUT);
  pinMode(DAT_PIN1, INPUT);
  pinMode(DAT_PIN2, INPUT);
  pinMode(DAT_PIN3, INPUT);
  pinMode(DAT_PIN4, INPUT);
  fidoDelay(500);
...
void gerkonLogic() {
    if (digitalRead(DAT_PIN0) == HIGH) {
      datPin0 = "ON";
    }
    if (digitalRead(DAT_PIN0) == LOW) {
      datPin0 = "OFF";
    }
    if (digitalRead(DAT_PIN1) == HIGH) {
      datPin1 = "ON";
    }
    if (digitalRead(DAT_PIN1) == LOW) {
      datPin1 = "OFF";
    }
    if (digitalRead(DAT_PIN2) == HIGH) {
      datPin2 = "ON";
    }
    if (digitalRead(DAT_PIN2) == LOW) {
      datPin2 = "OFF";
    }
    if (digitalRead(DAT_PIN3) == HIGH) {
      datPin3 = "ON";
    }
    if (digitalRead(DAT_PIN3) == LOW) {
      datPin3 = "OFF";
    }
    if (digitalRead(DAT_PIN4) == HIGH) {
      datPin4 = "ON";
    }
    if (digitalRead(DAT_PIN4) == LOW) {
      datPin4 = "OFF";
    }
}
