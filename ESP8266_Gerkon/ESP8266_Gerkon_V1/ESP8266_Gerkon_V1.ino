...
const String AP_PASS = "9e9f0e15";          // AP mode default password
const String STS_LOGIN = "904fc265";                 // Login to access settings in AP mode 
const String STS_PASS = "0ce99cdb";                    // Password to access settings in AP mode

...
const String END_POINT = "/gerkon/from_device";
const String SETTINGS_END_POINT = "/gerkon/device_settings";
////////////////////////////////////////////////////////////////////////////////////////////////////
...
void loop() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    if (digitalRead(gerkPin) == LOW) {
      sendRequest(HIDDEN_SERVER + END_POINT, "{\"serial_num\":\"" + SERIAL_NUMBER + "\", \"state\":\"OFF\"}");
    } else {
      sendRequest(HIDDEN_SERVER + END_POINT, "{\"serial_num\":\"" + SERIAL_NUMBER + "\", \"state\":\"ON\"}");
    }
  }else {
