...
void setup() {
  ...
  pinMode(REL_PIN0, OUTPUT);
  pinMode(REL_PIN1, OUTPUT);
  pinMode(REL_PIN2, OUTPUT);
  digitalWrite(REL_PIN0, LOW);
...
void resetbtn() {
  ...
  if (btnState == HIGH) {
    ...
    if (relay0 == "OFF" && relay1 == "OFF" && relay2 == "OFF") {
      digitalWrite(REL_PIN0, HIGH);
...
void getFromDevice() {
  ...
  String asr0 = doc["action_states_requested"][0];
  String ast0 = doc["action_states_taken"][0];
  String asr1 = doc["action_states_requested"][1];
  String ast1 = doc["action_states_taken"][1];
  String asr2 = doc["action_states_requested"][2];
  String ast2 = doc["action_states_taken"][2];
  if (asr0 == "ON" && ast0 == "NO") {
    digitalWrite(REL_PIN0, HIGH);
    relay0 = "ON";
  }
