...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
const String SERIAL_NUMBER = "00072162b50c";          // Serial number of the product
const String AP_LOGIN = "FidoElectronics21";       // Access Point (AP) mode default login
const String AP_PASS = "d0d01f95";          // AP mode default password
const String STS_LOGIN = "5d6b49eb";                 // Login to access settings in AP mode 
const String STS_PASS = "c502d77e";                    // Password to access settings in AP mode

...
const String END_POINT = "/fire_sensor/from_device";
const String SETTINGS_END_POINT = "/fire_sensor/device_settings";
////////////////////////////////////////////////////////////////////////////////////////////////////
...
int fireLogicCounter = 0;
String relay = "OFF";
int gasVal = 0;
String slaveServer = HIDDEN_SERVER;
int maxGasVal = 70;
int buzzDuration = 200;   // buzzer sound output at each 100 measurements
...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    sendRequest(HIDDEN_SERVER + END_POINT, "{\"serial_num\":\"" + SERIAL_NUMBER + "\", \"state\":\"" + relay + "\", \"gas_val\":\"" + gasVal + "\"}");
  } else {
...
void fireSensorLogic() {
  gasVal = analogRead(datPin);
  if (gasVal >= maxGasVal) {
    relay = "ON";
