...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
const String SERIAL_NUMBER = "0009210bd2e5";          // Serial number of the product
const String AP_LOGIN = "FidoElectronics25";       // Access Point (AP) mode default login
const String AP_PASS = "3c3fe6fc";          // AP mode default password
const String STS_LOGIN = "d33c2e16";                 // Login to access settings in AP mode 
const String STS_PASS = "ce11a6b9";                    // Password to access settings in AP mode

...
const String END_POINT = "/invertor/from_device";
const String SETTINGS_END_POINT = "/invertor/device_settings";
////////////////////////////////////////////////////////////////////////////////////////////////////
...
const int d2 = 4;
const int d5 = 14;
const int d6 = 13;         // this is actually D7  connect to D7
...
void loop() {
  if (WiFi.status() == WL_CONNECTED) {
    invertorLogic();
    sendRequest(HIDDEN_SERVER + END_POINT, "{\"serial_num\":\"" + SERIAL_NUMBER + "\", \"state\":\"" + invState + "\"}");
  } else {
