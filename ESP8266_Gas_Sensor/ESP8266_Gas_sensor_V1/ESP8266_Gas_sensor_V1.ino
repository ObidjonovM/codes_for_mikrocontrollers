...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
const String SERIAL_NUMBER = "00022137ffde";          // Serial number of the product
const String AP_LOGIN = "FidoElectronics3";       // Access Point (AP) mode default login
const String AP_PASS = "3f669375";          // AP mode default password
const String STS_LOGIN = "b225e5c6";                 // Login to access settings in AP mode 
const String STS_PASS = "f23dea2c";                    // Password to access settings in AP mode

...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    httpResp = sendRequest(HIDDEN_SERVER + END_POINT, "{\"serial_num\":\"" + SERIAL_NUMBER + "\", \"state\":\"" + relay + "\", \"gas_val\":\"" + gasVal + "\"}");
  } else {
